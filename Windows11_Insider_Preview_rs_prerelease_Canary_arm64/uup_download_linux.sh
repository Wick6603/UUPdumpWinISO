...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=dab78505-979f-4ed8-933b-d09b22fa0a04&pack=zh-cn&edition=professional%3Bcore&aria2=2"
if [ $? != 0 ]; then
