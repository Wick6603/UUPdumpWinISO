@echo off
:: Generated on 2026-09-14 13:22:03 GMT
...
:START_PROCESS
title 26200.9539_amd64_zh-cn_multi_b0605a8c download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b0605a8c-92ae-456c-b47c-81d48eae5f47&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=b0605a8c-92ae-456c-b47c-81d48eae5f47&pack=zh-cn&edition=core%%3Bprofessional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
